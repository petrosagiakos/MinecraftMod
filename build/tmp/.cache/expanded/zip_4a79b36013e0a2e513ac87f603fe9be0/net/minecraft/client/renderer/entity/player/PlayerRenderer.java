...
public class PlayerRenderer extends LivingEntityRenderer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public void render(AbstractClientPlayer p_117788_, float p_117789_, float p_117790_, PoseStack p_117791_, MultiBufferSource p_117792_, int p_117793_) {
        ...
        if (net.minecraftforge.client.event.ForgeEventFactoryClient.onRenderPlayerPre(p_117788_, this, p_117790_, p_117791_, p_117792_, p_117793_)) return;
        super.render(p_117788_, p_117789_, p_117790_, p_117791_, p_117792_, p_117793_);
        net.minecraftforge.client.event.ForgeEventFactoryClient.onRenderPlayerPost(p_117788_, this, p_117790_, p_117791_, p_117792_, p_117793_);
    }
    ...
    private static HumanoidModel.ArmPose getArmPose(AbstractClientPlayer p_117795_, InteractionHand p_117796_) {
        ...
        if (itemstack.isEmpty()) {
            ...
            var forgeArmPose = net.minecraftforge.client.extensions.common.IClientItemExtensions.of(itemstack).getArmPose(p_117795_, p_117796_, itemstack);
    ...
    public void renderRightHand(PoseStack p_117771_, MultiBufferSource p_117772_, int p_117773_, AbstractClientPlayer p_117774_) {
        if (!net.minecraftforge.client.event.ForgeEventFactoryClient.onRenderArm(p_117771_, p_117772_, p_117773_, p_117774_, HumanoidArm.RIGHT))
    ...
    public void renderLeftHand(PoseStack p_117814_, MultiBufferSource p_117815_, int p_117816_, AbstractClientPlayer p_117817_) {
        if (!net.minecraftforge.client.event.ForgeEventFactoryClient.onRenderArm(p_117814_, p_117815_, p_117816_, p_117817_, HumanoidArm.LEFT))
    ...
    protected void setupRotations(AbstractClientPlayer p_117802_, PoseStack p_117803_, float p_117804_, float p_117805_, float p_117806_, float p_335509_) {
        ...
        if (p_117802_.isFallFlying()) {
            ...
            super.setupRotations(p_117802_, p_117803_, p_117804_, p_117805_, p_117806_, p_335509_);
            float f4 = p_117802_.isInWater() || p_117802_.isInFluidType((fluidType, height) -> p_117802_.canSwimInFluidType(fluidType)) ? -90.0F - f1 : -90.0F;
